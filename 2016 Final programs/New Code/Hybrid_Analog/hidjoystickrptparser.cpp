...
int x, y;
int lpwm = 255, rpwm = 255;
const int subtract = 155;
...
void JoystickEvents::OnGamePadChanged(const GamePadEventData *evt) {
  ...
  if (x == 00 && y == 0xFF) {                                       // left diagonal back
    digitalWrite(fleftin2, HIGH);
    digitalWrite(fleftin1, LOW);
