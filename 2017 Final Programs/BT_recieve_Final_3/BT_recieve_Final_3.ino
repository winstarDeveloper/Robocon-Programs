...
unsigned int rpm, Angle, Pan, Velocity, stat, data[11], prevAngle, prevPan;
...
void serialPrint() {
  ...
  } else if (c == 2 && data[0] == 2) {
    Serial.print("Angle Values : "); Serial.println(data[1]);
  } else if (c == 2 && data[0] == 3) {
    Serial.print("Pan Value : "); Serial.println(data[1]);
  }
}
